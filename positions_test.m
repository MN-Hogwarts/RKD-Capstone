...
%position_1 = [0.003285 0.6247 1.528 1.807 1.042]';
...
position_1_approach = [0.1029 0.8373 1.191 1.256 1.681]';
...
for ind = 1:3
    ...
    command_trajectory(robot, trajectory, frequency);
    trajectory = trajectory_spline([position_2_approach position_2(:,ind)], [0, 1], frequency);
    command_trajectory(robot, trajectory, frequency);
    ...
    trajectory = trajectory_spline([position_2(:,ind) position_2_approach], [0, 1], frequency);
    command_trajectory(robot, trajectory, frequency);
